...
from constants import PUPPET_GRIPPER_POSITION_NORMALIZE_FN, SIM_TASK_CONFIGS, A1_GRIPPER_POSITION_NORMALIZE_FN
...
def main(args):
    ...
    for episode_idx in range(num_episodes):
        ...
        for joint, ctrl in zip(joint_traj, gripper_ctrl_traj):
            ...
            ctrl = A1_GRIPPER_POSITION_NORMALIZE_FN(ctrl[0])
            joint[6] = ctrl
